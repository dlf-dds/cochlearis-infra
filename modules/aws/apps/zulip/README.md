...
| [aws_iam_role_policy.efs_access](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy) | resource |
...
| <a name="input_container_image"></a> [container\_image](#input\_container\_image) | Docker image for Zulip | `string` | `"zulip/docker-zulip:latest"` | no |
| <a name="input_desired_count"></a> [desired\_count](#input\_desired\_count) | Desired number of ECS tasks | `number` | `1` | no |
| <a name="input_ecs_cpu"></a> [ecs\_cpu](#input\_ecs\_cpu) | CPU units for the ECS task (Zulip + PostgreSQL sidecar) | `number` | `2048` | no |
| <a name="input_ecs_memory"></a> [ecs\_memory](#input\_ecs\_memory) | Memory in MB for the ECS task (Zulip + PostgreSQL sidecar) | `number` | `4096` | no |
| <a name="input_listener_rule_priority"></a> [listener\_rule\_priority](#input\_listener\_rule\_priority) | Priority for the ALB listener rule | `number` | `200` | no |
...
| <a name="input_vpc_cidr"></a> [vpc\_cidr](#input\_vpc\_cidr) | VPC CIDR block for LOADBALANCER\_IPS configuration | `string` | `"10.0.0.0/16"` | no |
...
| <a name="output_db_endpoint"></a> [db\_endpoint](#output\_db\_endpoint) | Database endpoint (localhost sidecar) |
| <a name="output_domain"></a> [domain](#output\_domain) | Domain name for Zulip |
...
| <a name="output_url"></a> [url](#output\_url) | URL for Zulip |
<!-- END_TF_DOCS -->