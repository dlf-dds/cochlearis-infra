# RDS MySQL Module
#
# Creates a managed MySQL database with Secrets Manager integration.
...
resource "aws_db_subnet_group" "main" {
  name       = "${local.name_prefix}-${var.identifier}-mysql-subnet"
...
resource "aws_security_group" "rds" {
  name        = "${local.name_prefix}-${var.identifier}-mysql-sg"
...
resource "aws_security_group_rule" "rds_ingress" {
  ...
  description              = "Allow MySQL from allowed security groups"
}
